if obj_worldmap_cuphead.y > y{
	depth = obj_worldmap_cuphead.depth
}	else	{
...
if act == 0{
	...
	{	
		if global.flores == 0 || global.flores == 5{
		...
		if keyboard_check_pressed(global.kjump)
		{
			...
			if global.flores == 0{
			act = 1
			instance_create_depth(x, y-48, -100, obj_dialogue_greicy)
			}	
			if global.flores == 5{
			act = 1
			instance_create_depth(x, y-48, -100, obj_dialogue_greicy_1)	
			global.flores = 6
			}
		}
	}
